...
window['ExcalidrawWrapper'] = class {
  ...
  static getFontFamily(id) {
    switch (id) {
      ...
      case 4: return "BambooGrove, Segoe UI Emoji";
    }
  }
