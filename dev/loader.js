if (typeof window.ExcalidrawWrapper === 'undefined') {
  window.ExcalidrawConfig = {
    ...
    channel: 'dev',
    cljCodeVersion: 'excalidraw.app.dev.v32',
    DEBUG : true,
  ...
  ( async ()=>{
    ExcalidrawConfig.log('loader.js','rootPath:',ExcalidrawConfig.rootPath,'channel:',ExcalidrawConfig.channel,'debug?',ExcalidrawConfig.DEBUG);
      ...
      ExcalidrawConfig.addScriptToPage ('roam-excalidraw-excalidraw',ExcalidrawConfig.rootPath+ExcalidrawConfig.channel+'/lib/excalidraw.development.js?v='+ExcalidrawConfig.cljCodeVersion);
